...
pdfjam $FILE 16-18 --letterpaper -o facilities.pdf
pdfjam $FILE 19 --letterpaper -o patentspubs.pdf
pdfjam $FILE 22-23 --letterpaper -o IP.pdf
pdfjam $FILE 24 --letterpaper -o datasharing.pdf
pdfjam $FILE 25- --letterpaper -o refrences.pdf
