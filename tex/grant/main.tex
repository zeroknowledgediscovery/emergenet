...
% Our team proposes to develop a new platform called BioNORAD to help identify the risks posed by emerging Influenza A strains with high pandemic potential. This platform will use advanced algorithms to predict the evolutionary pathways of these viruses, enabling us to better understand the risks and take proactive steps to mitigate them.

% Current surveillance efforts rely on subject matter experts to score strains of concern based on ten different phenotypic aspects related to transmission and pathogenicity, a process that can take weeks or months to complete. The Emergenet algorithm that we will be using is the first of its kind to learn an appropriate biologically meaningful comparison metric from data without assuming any model of DNA or AA substitution or a genealogical tree a priori, enabling an actionable pandemic early warning system.

% We will be focusing on two key proteins in the virus, the HA and NA proteins, to better understand how mutations in these proteins can change the risk profile of a given virus. We will also expand our analysis to the complete viral genome, allowing us to understand the full range of possible mutations and how they might impact the virus's behavior.

% By analyzing these mutations and their impact on the virus, we hope to better understand the risks of emerging pandemics and develop proactive strategies for mitigating them. The Emergenet algorithm is the first of its kind to learn an appropriate biologically meaningful comparison metric from data without assuming any model of DNA or AA substitution or a genealogical tree a priori, enabling an actionable pandemic early warning system.

% Overall, our project is an innovative and ambitious effort to better understand the risks posed by emerging pandemics and develop proactive strategies for mitigating them. We believe that our approach has the potential to revolutionize our understanding of these risks and help us better protect the health and safety of people around the world. This project aligns with the FY23 PRMRP Portfolio Category: Infectious Diseases, FY23 PRMRP Topic:
% proteomics, and FY23 PRMRP Strategic Goal: Epidemiology: Identify strategies for surveillance or develop modeling tools and/or biomarkers to predict outbreaks or epidemics.
