...
\tikzexternaldisable
\usepackage{geometry}
\geometry{letterpaper, left=.5in,right=.5in,top=.5in,bottom=.5in,marginparwidth=.55in, % Adjust the width of the marginpar
...
\renewcommand\subsection{\@startsection {subsection}{2}{\z@}%
  ...
  {0ex \@plus.0ex}%
  {\fontsize{11}{11}\selectfont\bfseries\sffamily\color{Red3}}}
...
\renewcommand\paragraph{\@startsection {section}{1}{\z@}%
  ...
  {0.0ex \@plus.5ex}%
  {\fontsize{11}{10}\selectfont\bfseries\itshape\sffamily\color{Red2}}}
\makeatother
...
\newcommand{\BOX}[2]{\tikz{\node[fill=lightgray!40,inner sep=5pt,rounded corners=4pt] {\mnp{.98\textwidth}{\underline{\textbf{#1}}\vskip .5em #2}};}}
\newcommand{\BOXp}[2][Yellow2!40]{\tikz[baseline=-0.6ex]{\node[fill=#1,inner sep=2pt,draw=none, fill opacity=.5, text opacity=1,rounded corners=3pt, thin] {#2};}}
