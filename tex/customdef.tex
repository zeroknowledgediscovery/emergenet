...
\def\addressf{Department of Computer Science, University of Chicago, IL, USA}
\def\addressg{Committee on Computational and Applied Mathematics, University of Chicago, IL, USA}
...
\title{\LARGE \TITLE}
\author{\sffamily  \fontsize{10}{12}\selectfont   \authore$^{1,6}$,\authora$^{1,5}$,  \authorc$^{2,3}$, and \authord$^{1,4,7\bigstar}$\\                                                                
\vspace{10pt}                                                                   
