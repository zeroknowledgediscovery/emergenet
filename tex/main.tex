...
{\color{MediumBlue}
  {\bf \sffamily \fontsize{10}{12}\selectfont \noindent
    ...
    Influenza viruses constantly evolve~\cite{dos2016influenza}, typically producing small sequence alterations over a time scale of months that sufficiently perturb surface protein structures to evade host immunity, and cause the  seasonal flu epidemic. Such antigenic drifts necessitate yearly innoculation of the population with a  reformulated  vaccine,  targeting the predicted dominant  strain of the upconimg flu season.  Mismatches between predicted and actual dominant strains dramatically reduce  vaccine effectiveness~\cite{tricco2013comparing}, and despite a serious  impact on global health from the recurring yearly infection spikes,   prediction of the dominant strain is often imperfect. Furthermore, novel strains emerging into humans from animal reservoirs,  aided by  recombination of genes from past human strains, pose the even graver threat of a global pandemic. Despite global biosurveillance to  collect wild specimens from diverse hosts and geolocations, our current ability to objectively, reliably and scalably  evaluate the risk posed to  humans by  individual strains  is limited.  In this study, we introduce a new machine learning algorithm to automatically parse out emergent evolutionary constraints operating on viral sequences in the wild, allowing us to predict the likelihood of specific future  mutations, thereby yielding the  numerical likelihood of specific  strains emerging through natural evolutionary processes. We show that our approach yields forecasts that  outperform  WHO recommended flu vaccine compositions almost consistently over the past two decades, for both H1N1 and H3N2 subtypes, individually in the northern and the southern hemispheres. Additionally, we  replicate CDC's Influence Risk Assessment (IRAT) score for the pandemic potential of  influenza A viruses isolated from animal hosts. While  the IRAT evaluation for individual strains involves multiple experimental assays that typically take weeks to perform, our approach produces a highly correlated risk assessment in milliseconds. This dramatic reduction in time and cost potentially allows us to fully exploit current biosurvellinace capacity, scalably analyzing risk from  the tens of thousands of strains collected every year, and hence potentially deploy meaningful preemptive pandemic mitigation strategies. 
  }
}
...
Emerging from the recent  COVID-19 pandemic that caused one of the most devastating disasters of the past century, a looming question is whether we can prepare, preempt and mitigate such events in  future. Evolving viruses, both currently circulating in the human population, and those in animal reservoirs that can attain human-to-human transmission capability, pose an ever-present risk.  Current surveillance paradigms, while crucial for mapping disease ecosystems, are limited in their ability to address this challenge. Habitat encroachment, climate change, and other ecological factors~\cite{rulli2017nexus,chua2002anthropogenic,childs2004zoonotic} unquestionably drive up the odds of zoonotic spill-over. Nevertheless, efforts at tracking these effects have not improved our ability to quantify future risk of emergence of a specific strain from a specific host~\cite{fair2019viral}. Tracking viral diversity in hosts such as bats, birds or swines, while important, might not transparently map to emergence risk.  This is particularly true for Influenza, which partly on account of its segmented genome, is particularly adept in incorporating genes from multiple strains and emerge as novel human strains, thus harboring a high pandemic potential. While large antigenic shifts have been relatively rare, the smaller seasonal sequence alterations in Influenza A cause enough variation in the surface proteins to evade existing immunity, and require yearly reformulation of the flu vaccine.

However, for the flu vaccine to be effective, one must predict the dominant circulating strain of the upcoming flu season. The current approach to such prediction, which is based on the dominant strain sampled about 6 months before the seasonal infection peak [REF], often has had limited success. The ability to rank order strains which do not yet circulate in humans is even more limited, while simultaneously being more important, potentially having the ability to spillover and cause a global pandemic.
