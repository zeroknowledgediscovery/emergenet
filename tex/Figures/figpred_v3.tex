  ...
  \begin{tikzpicture}[anchor=center]
   ...
   nodes near coords style={
    ...
    \begin{axis}[enlargelimits=false,scale only axis=true,
      ...
      %ymax=7.6,
      xlabel={negative geometric mean of HA and NA \qdist },ylabel={CDC computed IRAT emergence score},xlabel style={yshift=-.1in},ylabel style={yshift=-.12in},
%axis x line=bottom,
%axis y line=left,
      ymin=3.5,
      xmin=1,
%ymax=7.7,
      ...
      table[x=Geom Mean Risk,
      y=Mean High Acceptable Emergence,col sep=comma] \RFILE;
...
%       y=Mean High Acceptable Emergence,x=Emergenet emergence estimate] \RFILE;
