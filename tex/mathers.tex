...
%Analyzing Haemagglutinnin (HA) and Neuraminidase (NA) sequences from $>400,000$ sequenced strains, we estimate the likelihood of specific future mutations, and the numerical odds of  specific descendants arising via natural processes.
...
Emergenet: A Digital Twin for Predicting Viral Emergence and Global Biosurveillance

Scientific Rationale and Need
Influenza A viruses continue to pose a major pandemic threat due to their segmented genome and the ability to reassort and mutate within animal reservoirs. Historical influenza pandemics, including those in 1918, 1957, 1968, and 2009, originated from zoonotic spillover events, demonstrating the ongoing risk of novel strains emerging. Despite global biosurveillance efforts that collect thousands of viral sequences annually, current methods for assessing the potential spillover risk remain limited. The CDC’s Influenza Risk Assessment Tool (IRAT) relies on expert-driven evaluation and time-intensive laboratory assays, which are not scalable for real-time global risk assessment.

To address this gap, Emergenet is designed as a computational framework that constructs a digital twin of viral sequence evolution, enabling real-time forecasting of potential zoonotic spillover events. This approach provides a scalable, data-driven alternative to traditional expert evaluation by rapidly assessing viral emergence risk based on mutational dependencies inferred from large-scale genomic datasets. The framework is further extended into BioNORAD, an operational prototype for continuous global biosurveillance that monitors and prioritizes high-risk viral strains before human transmission occurs.

Objectives and Aims
The project will begin with the development and validation of the Emergenet platform. This will involve constructing probabilistic models that capture cross-mutation dependencies in influenza genomes using publicly available sequence databases such as NCBI and GISAID. The Emergenet system will incorporate a novel emergence-distance (E-distance) metric to quantify the probability of a given viral strain evolving into a more transmissible or virulent form. By ranking animal strains based on their pandemic potential, this system will allow for rapid triaging of surveillance efforts. Predictions generated by Emergenet will be compared with historical IRAT assessments and past pandemic strains to evaluate its predictive accuracy. Retrospective analysis will determine whether Emergenet could have identified past pandemic strains before they achieved human-to-human transmission.

The second phase of the project involves experimental validation using reverse genetics. High-risk viral variants predicted by Emergenet will be generated in the lab through targeted mutagenesis. These engineered strains will be assessed for replication efficiency, host adaptation, and fitness in human lung epithelial cell lines and primary lung cells. Additional experiments will evaluate viral entry efficiency using receptor-binding assays, and antigenic properties will be analyzed through hemagglutination inhibition (HAI) tests. Competitive fitness assays will further determine whether Emergenet-predicted strains demonstrate increased replication efficiency compared to wild-type parental strains. The goal of these experiments is to confirm that mutations flagged by Emergenet indeed enhance viral fitness, while randomly selected mutations generally disrupt viral viability.

Clarification Regarding Gain-of-Function Research
It is important to emphasize that this project does not constitute gain-of-function (GoF) research as it does not involve engineering viruses to acquire new functions that increase transmissibility or pathogenicity beyond their natural evolutionary constraints. The mutations introduced during experimental validation are strictly limited to those that have already been observed in naturally circulating strains, ensuring that no novel, unnatural, or artificially enhanced viral phenotypes are generated. Additionally, all reverse genetics experiments will be conducted under stringent biosafety regulations (BSL-2/BSL-3 as required), with oversight from institutional biosafety committees. The primary goal of these experiments is to validate the accuracy of Emergenet’s predictive modeling in identifying naturally emerging viral variants, rather than generating more virulent or transmissible viruses. The focus remains on understanding evolutionary trajectories rather than enhancing viral capabilities, aligning fully with ethical and biosafety considerations.

The third phase of the project will deploy BioNORAD, a real-time biosurveillance system integrating Emergenet’s predictive capabilities. BioNORAD will automatically process and score new influenza sequences from global surveillance databases, continuously updating risk profiles for emerging strains. A user-friendly visualization dashboard will allow public health officials to track high-risk strains in real time, ensuring that actionable intelligence is available for pandemic preparedness. The system’s predictions will be evaluated by monitoring whether strains identified as high-risk later demonstrate increased human transmissibility or lead to outbreak events.

Anticipated Outcomes and Impact
The Emergenet framework will revolutionize pandemic risk assessment by enabling a scalable, AI-driven alternative to traditional expert evaluations. By providing real-time forecasting of viral emergence, the system will significantly enhance global preparedness efforts. The integration of BioNORAD will allow for preemptive action before zoonotic spillovers occur, ensuring that resources are allocated efficiently to monitor and contain high-risk viral strains. Experimental validation of Emergenet’s predictions will provide critical empirical support, demonstrating that the computational model can reliably identify biologically viable emergent strains. Ultimately, this project establishes a novel paradigm for pandemic prevention, transforming biosurveillance from a reactive system into a proactive global defense strategy.
