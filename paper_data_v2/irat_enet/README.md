...
│   └── irat_sequences : sequences of IRAT strains
├── results
...
├── irat_enet_current.ipynb : same as irat_enet_comparison.ipynb but using current data (i.e. evaluates current risk of IRAT strains)
