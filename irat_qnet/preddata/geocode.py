...
banner='GEOCODE GOOGLE LOOKUP'
zed='zed.uchicago.edu'
def str2bool(v):
...
parser.add_argument('-input', metavar="",dest='INFILE',
                    action="store", type=str,
                    default=[],
                    help="input file")
parser.add_argument('-output', metavar="",dest='OUTFILE',
                    action="store", type=str,
                    default=None,
                    help="output file")
parser.add_argument('-api', metavar="", dest='API',
                    action="store", type=str,
                    default='AIzaSyCEFICEj4R4zPnQlYVcyDmVnyW2exIZ3jE',
                    help="API")
parser.add_argument('-ADDR', metavar="", dest='ADDR_COLNAME',
                    action="store", type=str,
                    default='incident_address',
                    help="address col name")
...
address_column_name = args.ADDR_COLNAME
